...
def get_reward_functions():
    ...
    def get_base_stability_penalty(self):
        pitch_penalty = torch.square(self.base_euler[:, 1])
        roll_penalty = torch.square(self.base_quat[:, 0])
        return pitch_penalty * 2.0 + roll_penalty * 1.0
    ...
    def reward_tracking_lin_vel(self):
        ...
        return torch.exp(-lin_vel_error / 0.25) * (1 / get_base_stability_penalty(self))
    ...
    def reward_tracking_ang_vel(self):
        ...
        return torch.exp(-ang_vel_error / 0.25) * (1 / get_base_stability_penalty(self))
    ...
    # reward_functions.append((reward_lin_vel_z, -500.0))
    ...
    reward_functions.append((reward_base_height, -20.0))
